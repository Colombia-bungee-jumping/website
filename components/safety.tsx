...
const safetyFeatures = [
  {
    ...
    description:
      "Utilizamos exclusivamente cuerdas y arneses certificados por organismos internacionales, con revision antes de cada salto.",
  },
  {
    icon: Award,
    title: "Instructores Expertos",
    description:
      "Nuestro equipo cuenta con mas de 10 anos de experiencia y certificaciones internacionales en deportes extremos.",
  },
  {
    icon: Users,
    title: "Protocolo Riguroso",
    description:
      "Seguimos un protocolo de 25 puntos de seguridad verificados antes de cada salto. Tu seguridad es nuestra prioridad absoluta.",
  },
  {
    icon: HeartPulse,
    title: "Asistencia Medica",
    description:
      "Equipo medico de emergencia presente en cada ubicacion con ambulancia equipada y personal de primeros auxilios.",
  },
];
          ...
          <div>
            ...
            <AnimateOnScroll variant="blur-in" delay={200}>
              <p className="text-muted-foreground leading-relaxed mb-10 text-lg">
                En {company.name}, la seguridad no es negociable. Cada aspecto
                de nuestras operaciones esta disenado para que disfrutes la
                adrenalina con total tranquilidad.
              </p>
            </AnimateOnScroll>
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      Cumplimos con los estandares EN 15567 y ISO 22483
                    </p>
                  </div>
                </div>
              </div>
